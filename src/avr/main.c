...
/* Globals */
PORT avr_port = {
    TARGET_ID_AVR,     /* Unique id for this target */
    "avr",             /* Target name used for -m */
    "ATMEL AVR",       /* Target name string, used for --help */
    NULL,              /* processor */
    ...
    /* General info */
    {
     ...
     MODEL_LARGE | MODEL_SMALL, /* Supported models */
     MODEL_SMALL,               /* Default model */
     NULL,                      /* model == target */
    },
    
    /* Assembler related info */
    {
     _asmCmd,
     NULL,
