...
;	../_schar2fs.c: 56: return __slong2fs(sc);
	...
	idxm	a, p
	mov	p, a
	mov	a, ___schar2fs_sloc0_1_0+0
	idxm	p, a
	inc	p
	mov	a, ___schar2fs_sloc0_1_0+1
	idxm	p, a
	inc	p
	mov	a, ___schar2fs_sloc0_1_0+2
	idxm	p, a
	inc	p
	mov	a, ___schar2fs_sloc0_1_0+3
	idxm	p, a
;	../_schar2fs.c: 57: }
	ret
	.area CODE
